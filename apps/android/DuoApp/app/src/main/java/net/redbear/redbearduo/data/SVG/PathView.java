package net.redbear.redbearduo.data.SVG;
...
public class PathView extends View implements SvgUtils.AnimationStepListener {
    ...
    /**
     * All the paths provided to the net.redbear.redbearduo.view. Both from Path and Svg.
     */
    private List<SvgUtils.SvgPath> paths = new ArrayList<>();
    /**
     * This is a lock before the net.redbear.redbearduo.view is redrawn
    ...
    /**
     * If the net.redbear.redbearduo.view is filled with its natural colors after path drawing.
     */
    private boolean fillAfter;
    /**
     * The width of the net.redbear.redbearduo.view.
     */
    private int width;
    /**
     * The height of the net.redbear.redbearduo.view.
     */
    private int height;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        synchronized (mSvgLock) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                svgPath.paint.setAntiAlias(true);
    ...
    protected void onSizeChanged(final int w, final int h, int oldw, int oldh) {
        ...
        if (svgResourceId != 0) {
            ...
            }, "net.redbear.redbearduo.data.SVG Loader");
            mLoader.start();
        }
    }
     ...
     *
     * @param fillAfter - boolean if the net.redbear.redbearduo.view needs to be filled after path animation.
     */
    ...
    /**
     * Animator for the paths of the net.redbear.redbearduo.view.
     *
    ...
    /**
     * AnimatorSet for the paths of the net.redbear.redbearduo.view to be animated one after the other.
     *
     * @return The AnimatorBuilder to build the animation.
     */
    ...
    /**
     * Object for building the animation of the path of this net.redbear.redbearduo.view.
     */
    public static class AnimatorBuilder {
         ...
         * Default constructor.
         *
         * @param pathView The net.redbear.redbearduo.view that must be animated.
         */
    ...
    /**
     * Object for building the sequential animation of the paths of this net.redbear.redbearduo.view.
     */
