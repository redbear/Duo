...
public class SvgUtils {
    ...
    /**
     * The paint provided from the net.redbear.redbearduo.view.
     */
    ...
    public void load(Context context, int svgResource) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Could not load specified net.redbear.redbearduo.data.SVG resource", e);
        }
    }
     ...
     *
     * @param width  - the width to scale down the net.redbear.redbearduo.view to,
     * @param height - the height to scale down the net.redbear.redbearduo.view to,
