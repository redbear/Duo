...
//        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("WifiInstruction")
//        let rootViewController = self.window?.rootViewController as! RBDuoNavigationController
